...
java -Djava.io.tmpdir=. -jar $dir/bin/apktool.jar d --api 33 "$FRAMEWORK_JAR" -o "$FRAMEWORK_DIR"
...
java -Djava.io.tmpdir=. -jar $dir/bin/apktool.jar b --api 33 "$FRAMEWORK_DIR"
